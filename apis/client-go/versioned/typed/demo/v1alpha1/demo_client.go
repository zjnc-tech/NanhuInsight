...
import (
	...
	"github.com/zjnc-tech/NanhuInsight/apis/client-go/versioned/scheme"
...
// DemoV1alpha1Client is used to interact with features provided by the demo.nhi.zjlab.io group.
type DemoV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DemoV1alpha1Client) Demos(namespace string) DemoInterface {
